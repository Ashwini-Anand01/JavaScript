...
var absent=0; // here we give absent as 0 so that conditional operation when we perform we have already assign one value so that if other value will be present
if(randomnumber==0){
    console.log("absent");
}
else{
